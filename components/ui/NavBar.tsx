...
import { Menu, X, User, Code, Shield, FolderGit2, Mail as MailIcon, Award } from "lucide-react";
        ...
        <div className="hidden md:block">
          <LimelightNav 
            items={[
              ...
              { id: 'certificates', icon: <Award />, label: 'certificates', onClick: () => { document.querySelector('#certificates')?.scrollIntoView({ behavior: 'smooth' }) } },
