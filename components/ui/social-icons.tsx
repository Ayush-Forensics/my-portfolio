...
const socials = [
  {
    name: "GitHub",
    href: "https://github.com/Ayush-Forensics",
    icon: <Github size={18} />,
  },
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/ayush-forensics",
    icon: <Linkedin size={18} />,
  },
  {
    name: "Email",
    href: "mailto:ayushkr54881@gmail.com",
    icon: <Mail size={18} />,
  },
  {
    name: "X (Twitter)",
    ...
    <div className="relative flex items-center gap-0.5 px-1.5 py-1.5 rounded-2xl bg-neutral-950 border border-white/[0.08]">
      ...
      {socials.map((social, index) => (
        <a
          ...
          className="group relative flex items-center justify-center size-10 min-w-10 h-10 rounded-xl transition-colors duration-200"
