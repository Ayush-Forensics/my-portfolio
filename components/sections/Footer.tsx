    ...
    <footer className="border-t border-glass-border bg-[#020306] py-10 relative z-10">
      <div className="container mx-auto px-5 md:px-10 flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="flex gap-4">
          ...
          <a href="https://www.linkedin.com/in/ayush-forensics" target="_blank" rel="noopener noreferrer" className="w-8 h-8 flex items-center justify-center rounded-full bg-slate-800 text-slate-400 hover:bg-accent-primary hover:text-[#020306] transition-colors">
            <Linkedin size={14} />
          </a>
          <a href="https://github.com/Ayush-Forensics" target="_blank" rel="noopener noreferrer" className="w-8 h-8 flex items-center justify-center rounded-full bg-slate-800 text-slate-400 hover:bg-accent-primary hover:text-[#020306] transition-colors">
            <Github size={14} />
          </a>
        </div>
