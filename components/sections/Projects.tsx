...
export default function Projects() {
  ...
  return (
    <section id="projects" aria-label="Ayush Kumar forensic case files and investigation projects" className="py-24 relative">
...
function CaseCard({ id, status, icon, title, desc, items, tags, index }: CaseCardProps) {
