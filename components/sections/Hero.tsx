...
export default function Hero() {
  ...
  return (
    <section id="home" aria-label="Ayush Kumar Forensic Science and Cybersecurity Portfolio" className="relative min-h-[100svh] flex items-center overflow-hidden pt-[72px]">
      ...
      <div className="container mx-auto px-5 md:px-10 relative z-10 py-10 md:py-24">
        ...
        >
          {/* Visually-hidden keyword for SEO — primary keyword: 'Ayush Kumar forensic' */}
          <span className="sr-only">Ayush Kumar forensic science and digital forensics portfolio — </span>
          Ayush<br/>
