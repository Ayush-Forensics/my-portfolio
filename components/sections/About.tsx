...
export default function About() {
  ...
  return (
    <section id="about" aria-label="About Ayush Kumar — Applied & Digital Forensic Investigator" className="py-24 md:py-32 relative">
        ...
        <div className="grid md:grid-cols-[1fr_1.2fr] gap-10 md:gap-16 items-start">
          ...
          >
            ...
            <Image
              ...
              alt="Ayush Kumar — B.Sc. Forensic Science student and Forensisco Campus Ambassador at Parul University"
              width={400}
              height={533}
              priority
