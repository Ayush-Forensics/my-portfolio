      ...
      <div className="container mx-auto px-5 md:px-10">
        ...
        <div className="max-w-4xl">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            ...
            />
            <ContactCard 
              icon={<Linkedin size={20} />} label="LINKEDIN" val="ayush-forensics" 
              link="https://www.linkedin.com/in/ayush-forensics" delay={0.3} 
            />
            <ContactCard 
              icon={<Github size={20} />} label="GITHUB" val="github.com/Ayush-Forensics" 
              link="https://github.com/Ayush-Forensics" delay={0.4} 
            />
          </div>
        </div>
      </div>
...
function ContactCard({ icon, label, val, link, delay }: ContactCardProps) {
  return (
    <motion.a 
